...
HD_PWD='C:/iCloudDrive/~SchoolWork/Spring2024/ECE_4305/Lab_2/SquareWaveGen/SquareWaveGen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SquareWaveGen_basic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SquareWaveGen_basic.tcl -notrace
