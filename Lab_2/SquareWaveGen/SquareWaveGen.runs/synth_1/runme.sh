...
HD_PWD='C:/iCloudDrive/~SchoolWork/Spring2024/ECE_4305/Lab_2/SquareWaveGen/SquareWaveGen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SquareWaveGen_basic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SquareWaveGen_basic.tcl
